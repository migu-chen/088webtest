...
namespace WebApplication2
{
    class WeatherDataReader
    {
        ...
        {
            string url = "https://opendata.cwb.gov.tw/fileapi/v1/opendataapi/F-B0053-037?Authorization=CWB-4CB3C772-9DD5-4965-9BB4-9A91B289721F&downloadType=WEB&format=JSON";
                ...
                if (string.Compare("太魯閣國家公園太魯閣遊客中心", item.locationName, true) == 0)
                {
                    foreach (var weatherItem in item.weatherElement)
                    {
                        ...
                        if (weatherItem.elementName == "T")
                        {
                            ...
                            Console.WriteLine("太魯閣國家公園太魯閣遊客中心-目前溫度:" + weatherItem.time[0].elementValue);
                            //Console.WriteLine("太魯閣國家公園太魯閣遊客中心-目前溫度:" + measure.value + measure.measures);
                        ...
                        if (weatherItem.elementName == "PoP24h")
                        {
                            ...
                            var tjsonText = Newtonsoft.Json.JsonConvert.SerializeObject(eleVal);
                            MeasureObject measure = Newtonsoft.Json.JsonConvert.DeserializeObject<MeasureObject>(tjsonText);
                            Console.WriteLine("太魯閣國家公園太魯閣遊客中心-目前降雨率:" + weatherItem.time[0].elementValue);

                            // Console.WriteLine("太魯閣國家公園太魯閣遊客中心-目前降雨率:" + measure.value + measure.measures);
